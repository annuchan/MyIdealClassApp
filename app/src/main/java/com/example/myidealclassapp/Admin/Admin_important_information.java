    ...
    import com.example.myidealclassapp.Adapters.AdminImportInfoAdapter;
    ...
    public class Admin_important_information extends AppCompatActivity {
        private String employeeId;
        private RecyclerView recyclerView;
        private AdminImportInfoAdapter adapter;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_admin_important_information);
            ...
            adapter = new AdminImportInfoAdapter(this, infoList); // Тот же адаптер, если логика совпадает
        ...
        private void loadImportantInformation() {
            db.collection("Important_information")
                    ...
                    .addOnSuccessListener(queryDocumentSnapshots -> {
                        infoList.clear(); // Очистить список перед загрузкой новых данных
                    ...
                    .addOnFailureListener(e -> Log.e("TEST_FIRESTORE", "Ошибка Firestore: ", e));
        }
        ...
        public void moreButton(View view) {
            Intent intent = new Intent(this,  Admin_important_information_add.class);
            intent.putExtra("employee_id", employeeId);
            startActivity(intent);
        }
