...
public class Admin_main_window_more extends AppCompatActivity {
    private String employeeId;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_main_window_more);
    ...
    public void toImportInfo(View view) {
        Intent intent = new Intent(this, Admin_important_information.class);
        intent.putExtra("employee_id", employeeId);
        startActivity(intent);
    }
    public void toMeasure(View view) {
        Intent intent = new Intent(this, Admin_measure.class);
        intent.putExtra("employee_id", employeeId);
        startActivity(intent);
    }
    public void toAsset(View view) {
        Intent intent = new Intent(this, Admin_asset.class);
        intent.putExtra("employee_id", employeeId);
        startActivity(intent);
    }
    public void toTeacher(View view) {
        Intent intent = new Intent(this, Admin_teacher.class);
        intent.putExtra("employee_id", employeeId);
        startActivity(intent);
    }
    public void ToStudent(View view) {
        Intent intent = new Intent(this, Admin_student.class);
        intent.putExtra("employee_id", employeeId);
        startActivity(intent);
    }
    public void toParent(View view) {
        Intent intent = new Intent(this, Admin_parent.class);
        intent.putExtra("employee_id", employeeId);
        startActivity(intent);
    }
    /// Скрытие всех баров
