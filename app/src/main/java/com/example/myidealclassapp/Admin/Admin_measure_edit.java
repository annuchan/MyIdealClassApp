...
public class Admin_measure_edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        employeeId = intent.getStringExtra("Id_Employee");
    ...
    private void uploadImageToImgBB(Bitmap bitmap) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(Admin_measure_edit.this, "Ошибка загрузки изображения", Toast.LENGTH_SHORT).show());
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (url != null) {
                    runOnUiThread(() -> {
                        ...
                        imageChanged = true;
                        Glide.with(Admin_measure_edit.this)
                                .load(url)
                                .placeholder(R.drawable.school2)
                                .into(imageView);
                    ...
                    runOnUiThread(() -> Toast.makeText(Admin_measure_edit.this, "Ошибка обработки ответа ImgBB", Toast.LENGTH_SHORT).show());
                }
            }
        });
    }
