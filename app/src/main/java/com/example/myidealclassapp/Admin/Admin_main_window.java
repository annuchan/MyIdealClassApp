...
public class Admin_main_window extends AppCompatActivity {
    private String employeeId;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_main_window);
        /// получение емплое айди
    ...
    public void toMainMore(View view) {
        Intent intent = new Intent(this, Admin_main_window_more.class);
        intent.putExtra("employee_id", employeeId);
        startActivity(intent);
    }
