...
import com.example.myidealclassapp.Adapters.AdminEmployeeAdapter;
...
public class Admin_teacher extends AppCompatActivity {
    ...
    private static final int ADD_TEACHER_REQUEST_CODE = 103;
    private String employeeId;
    private RecyclerView recyclerView;
    private AdminEmployeeAdapter adapter;
    private List<Employees> teacherList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.homeworkRecyclerView); // Убедись, что в layout такой ID
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapter = new AdminEmployeeAdapter(this, teacherList);
    ...
    public void moreButton(View view) {
        Intent intent = new Intent(this, Admin_teacher_add.class);
        intent.putExtra("employee_id", employeeId);
        startActivity(intent);
    }
        ...
        db.collection("Employees")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    for (QueryDocumentSnapshot doc : queryDocumentSnapshots) {
                        Employees teacher = doc.toObject(Employees.class);
                        teacherList.add(teacher);
                    }
                    adapter.notifyDataSetChanged();
                    LoadingUtil.hideLoadingWithAnimation(this);
                })
                .addOnFailureListener(e -> Log.e("Firestore", "Ошибка при загрузке учителей", e));
    }
}
