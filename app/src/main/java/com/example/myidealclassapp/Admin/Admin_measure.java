...
import com.example.myidealclassapp.Adapters.AdminMeasureAdapter;
...
public class Admin_measure extends AppCompatActivity {

    private static final int ADD_MEASURE_REQUEST_CODE = 100;
    private String employeeId;
    private RecyclerView recyclerView;
    private AdminMeasureAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_measure);
        ...
        adapter = new AdminMeasureAdapter(this, measureList);
    ...
    public void moreButton(View view) {
        Intent intent = new Intent(this, Admin_measure_add.class);
        intent.putExtra("employee_id", employeeId);
        startActivity(intent);
    }
