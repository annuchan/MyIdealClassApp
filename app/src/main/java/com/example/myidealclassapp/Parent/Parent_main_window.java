...
public class Parent_main_window extends AppCompatActivity {
    private int currentStudentId;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_parent_main_window);
        // НЕ задаём отступы, пусть контент уходит под статус-бар
    ...
    public void toMainMore(View view) {
        Intent intent = new Intent(this, Parent_main_window_more.class);
        intent.putExtra("EXTRA_STUDENT_ID", currentStudentId);
