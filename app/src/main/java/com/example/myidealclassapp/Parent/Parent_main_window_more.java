...
public class Parent_main_window_more extends AppCompatActivity {
    private int currentStudentId;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_parent_main_window_more);
    ...
    public void toSchool(View view) {
        Intent intent = new Intent(this, Parent_school_page.class);
        intent.putExtra("EXTRA_STUDENT_ID", currentStudentId);
        startActivity(intent);
    }
    public void toHomework(View view) {
        Intent intent = new Intent(this, Parent_homework.class);
        intent.putExtra("EXTRA_STUDENT_ID", currentStudentId);
        startActivity(intent);
    }
    public void toImpInfo(View view) {
        Intent intent = new Intent(this, Parent_important_information.class);
        intent.putExtra("EXTRA_STUDENT_ID", currentStudentId);

        startActivity(intent);
    }
    public void toMeasure(View view) {
        Intent intent = new Intent(this, Parent_measure.class);
        intent.putExtra("EXTRA_STUDENT_ID", currentStudentId);
        startActivity(intent);
    }
    public void toAsset(View view) {
        Intent intent = new Intent(this, Parent_asset.class);
        intent.putExtra("EXTRA_STUDENT_ID", currentStudentId);
        startActivity(intent);
    }
    public void toTeacher(View view) {
        Intent intent = new Intent(this, Parent_teacher.class);
        intent.putExtra("EXTRA_STUDENT_ID", currentStudentId);
        startActivity(intent);
    }
    ...
    public void evalution(View view) {
        Intent intent = new Intent(this, Parent_Evalution.class);
        intent.putExtra("EXTRA_STUDENT_ID", currentStudentId);
        startActivity(intent);
    }
    @Override
