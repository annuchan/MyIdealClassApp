...
public class Parent_important_information extends AppCompatActivity {
    private int currentStudentId;
    private RecyclerView recyclerView;
    private ParentImportInfoAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_important_information);
        ...
        adapter = new ParentImportInfoAdapter(this, infoList);
